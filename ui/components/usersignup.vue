    ...
    <v-container >
        <v-row align="center">
            ...
            <v-row>
                ...
                <v-col cols="12">
                    <v-text-field outlined :textarea="true" class="text-field-in-box" v-model="user.email" prepend-icon="mdi-email" label="Personal Email" :rules="[rules.required,rules.email]"></v-text-field>
                </v-col>
