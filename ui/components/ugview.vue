...
export default{
    ...
    async deny(email, ug_regno, name){
        ...
        let rdata={
          ...
          We regret to inform you that your application with UG Data has been rejected due to ${this.email_body}. Our team reviewed your application carefully, and unfortunately, we are unable to proceed with your application at this time.

          We appreciate your interest in our services and your effort in applying. Thank you for considering us, and reupload the UG Data .
